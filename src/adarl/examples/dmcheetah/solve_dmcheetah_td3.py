...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    folderName, session = adarl.utils.session.adarl_startup(__file__, inspect.currentframe(), seed=seed)
    ...
    model = TD3( MultiInputPolicy, env, action_noise=action_noise, verbose=1, batch_size=100,
                    ...
                    replay_buffer_kwargs = {"storage_torch_device":adarl.utils.utils.torch_selectBestGpu()})
