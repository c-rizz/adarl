...
from adarl.envs.panda.PandaEffortStayUpEnv import PandaEffortStayUpEnv
...
def trainOrLoad(env : adarl.envs.BaseEnv.BaseEnv, trainIterations : int, episodeLength : int, fileToLoad : str = None) -> None:
