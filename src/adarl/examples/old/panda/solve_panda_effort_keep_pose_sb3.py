...
from adarl.envs.panda.PandaEffortKeepPoseEnv import PandaEffortKeepPoseEnv
from adarl.envs.GymEnvWrapper import GymEnvWrapper
from stable_baselines3.common.callbacks import CheckpointCallback

def run(env : gymnasium.Env, model : stable_baselines3.common.base_class.BaseAlgorithm, numEpisodes : int = -1):
    #frames = []
