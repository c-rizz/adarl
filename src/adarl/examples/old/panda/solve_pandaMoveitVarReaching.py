...
import adarl_ros
from adarl.envs.panda.PandaMoveitVarReachingEnv import PandaMoveitVarReachingEnv
...
def main(fileToLoad : str = None, real : bool = False, robot_ip : str = None) -> None:
    ...
    def sampleGoal(rng):
        ...
        p = adarl.utils.utils.build_pose(x=position[0],y=position[1],z=position[2],qx=0.707, qy=0, qz=0.707, qw=0)
        return p
