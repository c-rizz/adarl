...
class PrintLrRunInfo(BaseCallback):
    ...
    def _on_step(self):
        ...
        adarl.utils.session.default_session.run_info["collected_episodes"] = self._episode_counter
        adarl.utils.session.default_session.run_info["collected_steps"] = self._episode_counter
        return True
