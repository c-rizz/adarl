...
def build_sim(render):
    ...
    # </mujoco>
    # """
    model_definition_string = lr_gym.utils.utils.compile_xacro_string(  model_definition_string=Path(lr_gym.utils.utils.pkgutil_get_path("lr_gym","models/cartpole_v0.urdf.xacro")).read_text(),
                                                                        model_kwargs={})
